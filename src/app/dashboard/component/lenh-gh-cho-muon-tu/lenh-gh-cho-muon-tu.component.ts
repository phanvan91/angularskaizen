...
@Component({
  selector: 'app-lenh-gh-cho-muon-tu',
  templateUrl: './lenh-gh-cho-muon-tu.component.html',
  styleUrls: ['./lenh-gh-cho-muon-tu.component.scss']
})
export class LenhGhChoMuonTuComponent implements OnInit {
  ...
  ngOnInit() {
    ...
    this.ajaxOptions_serial = {
      ...
      this.lenhGiaoHang = {
        ...
        ly_do: null,
        ghi_chu: 'CHO KH KÝ NHẬN VÀ NHẬN TỦ HƯ VỀ',
        chi_tiet: []
    };
