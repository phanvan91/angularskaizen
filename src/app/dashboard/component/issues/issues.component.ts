...
export class IssuesComponent implements OnInit {
  ...
  ngOnInit() {
    this.khoService.khoSelected.subscribe((res:any)=>{
      if(res.length){
        this.khoXuat = res.find(x=>x.loai_kho ==  environment.loai_kho.kho_tot);
        this.onLoadAllData();
      }
    })
  }
  ...
  onSearch(){
    ...
    this.chungTuService.filterListChungTuKhoTot(environment.loai_chung_tu.phieu_xuat_kho,this.khoXuat.id,
